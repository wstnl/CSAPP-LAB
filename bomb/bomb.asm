...
0000000000400f43 <phase_3>:
  ...
  400f75:	ff 24 c5 70 24 40 00 	jmpq   *0x402470(,%rax,8)        # *0x402470 = 0x400f7c, should be *(0x402470(,%rax,8))
  400f7c:	b8 cf 00 00 00       	mov    $0xcf,%eax                # 207, 0
  400f81:	eb 3b                	jmp    400fbe <phase_3+0x7b>
  400f83:	b8 c3 02 00 00       	mov    $0x2c3,%eax               # 707, 2
  400f88:	eb 34                	jmp    400fbe <phase_3+0x7b>
  400f8a:	b8 00 01 00 00       	mov    $0x100,%eax               # 256, 3
  400f8f:	eb 2d                	jmp    400fbe <phase_3+0x7b>
  400f91:	b8 85 01 00 00       	mov    $0x185,%eax               # 389, 4
  400f96:	eb 26                	jmp    400fbe <phase_3+0x7b>
  400f98:	b8 ce 00 00 00       	mov    $0xce,%eax                # 206, 5
  ...
  400fb9:	b8 37 01 00 00       	mov    $0x137,%eax               # 311, 1
...
000000000040100c <phase_4>:
  ...
  401010:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx         # argument 1
  401015:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx         # argument 2
